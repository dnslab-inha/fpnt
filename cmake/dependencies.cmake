# How to add Libraries using CPM's CPMAddPackage Examples
# CPMAddPackage("gh:vincentlaucsb/csv-parser#2.2.1") # csv-parser does not use version (prefix 'v'
# is added in tag) in their repository CPMAddPackage("gh:CLIUtils/CLI11@2.3.2") # CLI11 uses the
# version prefix in their repository gh: github,  @ version, # tag

# CPMAddPackage("gh:fmtlib/fmt#master") CPMAddPackage("gh:fmtlib/fmt#12.0.0")
...
if(TARGET csv)
  ...
  # 1. BUILD_INTERFACE 제너레이터 표현식을 사용하여 경로를 다시 설정합니다. 이렇게 하면 CMake가 '빌드 시에만 쓰는 경로'임을 인지하여 에러를 내지 않습니다.
  target_include_directories(
    csv INTERFACE $<BUILD_INTERFACE:${csv_SOURCE_DIR}/include>
