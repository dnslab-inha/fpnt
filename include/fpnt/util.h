...
inline std::pair<std::string, std::string> pair_split(const std::string& key,
...
inline std::vector<std::string> split(const std::string& str, const char separator) {
  ...
  std::string item;
  while (getline(iss, item, separator)) result.push_back(item);

  return result;
}

inline std::vector<std::string> split_with_trim(const std::string& str,
                                                const std::string& delimiters,
                                                bool do_not_allow_empty = false) {
  std::vector<std::string> result;
